...
const StatCard = ({ title, value, icon, gradient, percentage, subtext }) => {
  return (
    <div
      className={`relative overflow-hidden rounded-xl bg-gradient-to-br ${gradient} p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1`}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="flex justify-between mt-3 text-sm text-gray-600 dark:text-gray-400">
              <span>
                {data?.finishedProjectsCount || 0} {content.completed}
              </span>
              <span>
                {(data?.projectsCount || 0) -
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="flex justify-between mt-3 text-sm text-gray-600 dark:text-gray-400">
              <span>
                {data?.finishedTasksCount || 0} {content.completed}
              </span>
              <span>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                  {language === "ar"
                    ? "من إجمالي المهام والمشاريع"
                    : "of total tasks & projects"}
                </p>
              </div>
              ...
              <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                  {language === "ar"
                    ? "مهام ومشاريع قيد العمل"
                    : "tasks & projects in progress"}
                </p>
              </div>
