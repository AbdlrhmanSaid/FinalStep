...
export default function ProjectTeamSection({
  ...
  const Content = (
    <div className="space-y-3">
      {/* Leader Row */}
      <div className="group relative flex items-center gap-3 p-2.5 rounded-2xl border border-amber-100/50 bg-amber-50/20 dark:border-amber-900/20 dark:bg-amber-900/10 transition-colors">
        <div className="relative">
          <div className="w-10 h-10 rounded-full bg-linear-to-br from-amber-400 to-orange-500 border-2 border-white dark:border-gray-800 flex items-center justify-center overflow-hidden">
